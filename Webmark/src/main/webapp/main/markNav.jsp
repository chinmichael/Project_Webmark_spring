				...
				<li class="nav-item dropdown"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
						<a class="dropdown-item" href="/Webmark/account/AccountModify.jsp">Account</a>
							...
							<a class="dropdown-item" href="/Webmark/WebmarkServlet?command=logout">Logout</a>
					</div></li>
			</ul>
			

			<form class="form-inline my-1 my-lg-0" method = "post" action = "/Webmark/WebmarkServlet?command=search_url">
		...
		<div class="row min-vh-100 flex-column flex-md-row" style = "margin-bottom: 50px;">
			...
			<aside class="col-12 col-md-2 p-0 bg-light flex-shrink-1"
				...
				<nav
					...
					<a class="navbar-brand" href="/Webmark/main/markList.jsp"><i class="fas fa-swatchbook"></i>
						&nbsp;Category</a>
					<button class="navbar-toggler" type="button" data-toggle="collapse"
						...
						<div class="navbar-nav">
							<ul
								...
								<li class="nav-item"><a class="nav-link"
										href="/Webmark/WebmarkServlet?command=notice_list">
								...
								<c:forEach var="category" items="${categoryList }">
									<li class="nav-item"><a class="nav-link"
										href="/Webmark/WebmarkServlet?command=url_list&cat_no=${category.cat_no }">
