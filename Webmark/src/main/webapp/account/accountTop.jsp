...
<head>
<meta charset="UTF-8">
<title>Webmark Account Manage</title>
<meta name="viewport"
...
<body>
	...
	<div class="container-fluid">
		<div class="row min-vh-100 flex-column flex-xl-row" style = "margin-bottom: 50px;">
			...
			<aside class="col-12 col-xl-2 p-0 bg-light flex-shrink-1" style="overflow: auto;">
				
				<nav class="navbar navbar-expand-xl navbar-light bg-light flex-xl-column flex-md-row align-items-start py-2">
					<a class="navbar-brand" href="/Webmark/home/accountHome.html">
						<i class="fas fa-user-circle"></i>&nbsp;&nbsp;Account Category</a>
					<button class="navbar-toggler" type="button" data-toggle="collapse"
						...
						<div class="navbar-nav">
							<ul class="flex-md-column navbar-nav w-100 justify-content-between">
								...
								<li class="nav-item" style="margin-top:5px;">
									<a class="nav-link" href="/Webmark/home/accountManage.html">
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<i class="fas fa-pen-nib"></i>&nbsp;&nbsp;Account Manage
									</a>
								</li>
								...
								<li class="nav-item" style="margin-top:5px;">
									<a class="nav-link" href="/Webmark/account/accountDrop.jsp">
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<i class="fas fa-sign-out-alt"></i>&nbsp;&nbsp;Account Drop
									</a>
								</li>
								...
								<li class="nav-item" style="margin-top:5px;">
									<a class="nav-link" href="/Webmark/account/accountPermission.jsp">
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<i class="fas fa-arrow-alt-circle-up"></i>&nbsp;&nbsp;Permission change
									</a>
								</li>
								</c:if>
							</ul>
