	...
	<div class="container-fluid" style= "background-color:#D8D8D8;">
		...
		<div class="card border-light mb-3 mx-auto" style="max-width: 23rem; margin-top: 60px;">
			...
			<div class="card-body text-secondary">
				<form:form modelAttribute="accountVO" action="/Webmark/account/join.html" method="post" name="joinFrm">
					<p class="card-text" style="margin-bottom: 5px;">ID :</p>
					<div class="form-group">
						<form:input cssClass="form-control" path="userid" value="${joinError.getUserid() }"/>
					</div>
					<p class="card-text" style="margin-bottom: 5px;">E-mail :</p>
					<div class="form-group">
						<form:input cssClass="form-control" path="email" value="${joinError.getEmail() }"/>
					</div>
					<p class="card-text" style="margin-bottom: 5px;">Name :</p>
					<div class="form-group">
						<form:input cssClass="form-control" path="username" value="${joinError.getUsername() }"/>
					</div>
					<p class="card-text" style="margin-bottom: 5px;">Nick :</p>
					<div class="form-group">
						<form:input cssClass="form-control" path="usernick" value="${joinError.getUsernick() }"/>
					</div>
					<p class="card-text" style="margin-bottom: 5px;">Password :</p>
					<div class="form-group">
						<form:password cssClass="form-control" path="userpw" value="${joinError.getUserpw() }"/>
					</div>
